...
public class ThanhToanAdapter extends ArrayAdapter<MonAn> {
    Activity context;
    int resource;
    public ThanhToanAdapter(@NonNull Activity context, int resource) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView txtSoLuong = cus.findViewById(R.id.txtSoLuongCuaMonAn);
        ...
        txtSoLuong.setText(Integer.toString(monAn.getQuantity()));
