...
public class SignUpActivity extends AppCompatActivity {
    ...
    EditText edtUsernameSignUp, edtPasswordSignUp, edtConfirmPassword;
    @Override
        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (((cursor != null) && (cursor.getCount() > 0))) {
                    Toast.makeText(SignUpActivity.this, "Tai khoan da ton tai", Toast.LENGTH_SHORT).show();
                    edtUsernameSignUp.setText("");
                }
                else {
                    if (password.equals(password_confirm)) {
                        database.QueryData("INSERT INTO USER VALUES('" + username + "', '" + password + "', 1)");
